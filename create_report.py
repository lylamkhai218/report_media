...
<head>
    ...
    <style>
        ...
        *, *::before, *::after {
        ...
        /* Sticky horizontal column for Post Title on mobile/all screens */
...
<body class="min-h-screen">
            ...
            <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-gray-800 pb-5 mb-5" style="display:flex; flex-direction:column; border-bottom:1px solid #1f2937; padding-bottom:16px; margin-bottom:16px;">
                ...
                <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 w-full md:w-auto" style="display:flex; flex-direction:column; gap:12px; margin-top:12px;">
                    ...
                    <div class="flex items-center gap-1.5 self-stretch sm:self-auto" style="display:flex; gap:6px;">
                        <button id="sort-views-btn" class="flex-1 sm:flex-none px-3.5 py-2.5 text-xs font-bold bg-indigo-600 text-white rounded-lg transition-colors whitespace-nowrap" style="flex:1; background-color: #4f46e5; color: white; padding: 10px 14px; border-radius: 8px; border:none; font-size:12px; font-weight:700; cursor:pointer; white-space: nowrap;" data-i18n="table_sort_views">Xem nhiều nhất</button>
                        <button id="sort-ret-btn" class="flex-1 sm:flex-none px-3.5 py-2.5 text-xs font-bold bg-gray-800 text-gray-300 hover:bg-gray-700 rounded-lg transition-colors whitespace-nowrap" style="flex:1; background-color: #374151; color: #d1d5db; padding: 10px 14px; border-radius: 8px; border:none; font-size:12px; font-weight:700; cursor:pointer; white-space: nowrap;" data-i18n="table_sort_ret">Giữ Chân 50%</button>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        document.getElementById('sort-views-btn').addEventListener('click', (e) => {
            ...
            btnViews.className = "flex-1 sm:flex-none px-3.5 py-2.5 text-xs font-bold bg-indigo-600 text-white rounded-lg transition-colors whitespace-nowrap";
            btnRet.style.backgroundColor = "#374151";
            btnRet.style.color = "#d1d5db";
            btnRet.className = "flex-1 sm:flex-none px-3.5 py-2.5 text-xs font-bold bg-gray-800 text-gray-300 hover:bg-gray-700 rounded-lg transition-colors whitespace-nowrap";
            renderTable();
        });
        ...
        document.getElementById('sort-ret-btn').addEventListener('click', (e) => {
            ...
            btnRet.className = "flex-1 sm:flex-none px-3.5 py-2.5 text-xs font-bold bg-indigo-600 text-white rounded-lg transition-colors whitespace-nowrap";
            btnViews.style.backgroundColor = "#374151";
            btnViews.style.color = "#d1d5db";
            btnViews.className = "flex-1 sm:flex-none px-3.5 py-2.5 text-xs font-bold bg-gray-800 text-gray-300 hover:bg-gray-700 rounded-lg transition-colors whitespace-nowrap";
            renderTable();
        });
